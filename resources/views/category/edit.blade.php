...
<form action="{{ route('categories.update',$category->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4">
            <img class="img-responsive" id="imagePreview" src="{{asset('uploads/thumbnail/'.$category->image)}}" height="100" width="100">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
...
<script type="text/javascript">
    $(document).ready(function() {
        var parent_id = "{{old('parent_id', $category->parent_id)}}";
        var url = "{{ route('get-categories-dropdown', $category->id) }}";
